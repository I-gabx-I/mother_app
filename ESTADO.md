...
- **Fases 00-04: cerradas, tageadas y mergeadas a `main`** —
  ...
  mergeado a `main`.
- **`fix/money-field-plain-decimal` (2026-09-19/20): listo para merge,
  un commit, sin tag.** Reemplaza el buffer de dígitos de Fase 03 por
  un campo de texto decimal normal con filtro de entrada (D-030), tras
  un error de captura silencioso en la prueba con la usuaria real. Ver
  "Fix `money-field-plain-decimal` — Cierre" al final.
